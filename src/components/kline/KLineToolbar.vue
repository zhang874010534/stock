...
const emit = defineEmits(['period-change', 'range-change', 'ma-change', 'indicator-change'])
...
.toolbar-main { flex-wrap: wrap; gap: 10px; }
...
.ma-menu { position: absolute; top: calc(100% + 6px); left: 0; z-index: 5; width: 154px; padding: 10px; border: 1px solid #414552; border-radius: 5px; background: #1c1e26; box-shadow: 0 8px 24px #0008; }
